...
--
-- Table structure for table `comboservices`
--

DROP TABLE IF EXISTS `comboservices`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `comboservices` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `comboServicesName` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'tên dịch vụ',
  `comboServicesCode` varchar(45) DEFAULT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='combo dịch vụ';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `comboservices`
--

LOCK TABLES `comboservices` WRITE;
/*!40000 ALTER TABLE `comboservices` DISABLE KEYS */;
/*!40000 ALTER TABLE `comboservices` ENABLE KEYS */;
UNLOCK TABLES;
