...
DROP TABLE IF EXISTS `receiptsproducts`;
...
LOCK TABLES `receiptsproducts` WRITE;
/*!40000 ALTER TABLE `receiptsproducts` DISABLE KEYS */;
/*!40000 ALTER TABLE `receiptsproducts` ENABLE KEYS */;
UNLOCK TABLES;
