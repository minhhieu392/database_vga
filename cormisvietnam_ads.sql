...
CREATE TABLE `ads` (
  ...
  `adsTypeId` bigint(20) NOT NULL,
  `adsPositionsId` bigint(20) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `title_sites_index` (`title`,`sitesId`)
...
INSERT INTO `ads` VALUES (1,'ghhfghdsadas',NULL,'[]',1,24,25,1,'2021-05-25 18:31:20',1,NULL,1);
