...
--
-- Table structure for table `comboproductsdetails`
--

DROP TABLE IF EXISTS `comboproductsdetails`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `comboproductsdetails` (
...
--
-- Dumping data for table `comboproductsdetails`
--

LOCK TABLES `comboproductsdetails` WRITE;
/*!40000 ALTER TABLE `comboproductsdetails` DISABLE KEYS */;
/*!40000 ALTER TABLE `comboproductsdetails` ENABLE KEYS */;
UNLOCK TABLES;
